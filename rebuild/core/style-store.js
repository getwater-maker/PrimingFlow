...
const BUILT_IN_STYLES = [
  { id: 'k-webtoon',         name: '한국 웹툰',           prompt: 'beautiful Korean webtoon style, manhwa art, soft shading, detailed characters, emotional expressions, Korean comic illustration, clean lineart, pastel colors, no watermark' },
  { id: 'webtoon-illust',    name: '웹툰 일러스트',       prompt: 'webtoon illustration style, digital painting, semi-realistic, vivid colors, detailed background, Korean manhwa inspired, clean composition, no watermark' },
  { id: 'cinematic',         name: '시네마틱 (영화풍)',   prompt: 'cinematic film still, dramatic lighting, movie scene, no watermark' },
  { id: 'photorealistic',    name: '포토리얼 (실사)',     prompt: 'photorealistic photography, high detail, natural lighting, 8K, no watermark' },
  { id: 'illustration',      name: '일러스트',            prompt: 'digital illustration, clean lines, warm colors, detailed, no watermark' },
  { id: 'anime',             name: '애니메이션',          prompt: 'anime style illustration, vibrant colors, expressive characters, Japanese animation, no watermark' },
  { id: 'watercolor',        name: '수채화',              prompt: 'traditional watercolor painting, aquarelle, wet-on-wet technique, visible paper texture, soft pastel color washes, flowing translucent pigments, hand-painted on cotton paper, loose brush strokes, bleeding colors, artistic fine art, NOT digital illustration, NOT line art, NOT webtoon, NOT manhwa, NOT anime, no watermark' },
  { id: 'biblical-watercolor', name: '수채화 (성경시대)', prompt: 'traditional watercolor painting of ancient biblical era, aquarelle, wet-on-wet technique, visible paper texture, soft earth-tone washes (ochre, sand, olive, terracotta), flowing translucent pigments, hand-painted on cotton paper, loose brush strokes, ancient Middle Eastern setting, biblical figures in flowing robes and tunics, head coverings, sandals, bearded elders, Holy Land landscape with olive trees and stone buildings, reverent atmosphere, sacred scripture illustration, fine art, NOT digital illustration, NOT line art, NOT webtoon, NOT manhwa, NOT anime, NOT modern clothing, NOT Korean historical drama, no watermark' },
  { id: 'ink',               name: '수묵화',              prompt: 'ink wash painting, traditional, minimalist, elegant brush strokes, no watermark' },
  { id: 'oil',               name: '유화',                prompt: 'oil painting, classical, rich colors, elegant brushwork, fine art, no watermark' },
  { id: 'fantasy',           name: '판타지 아트',         prompt: 'fantasy art, epic scene, magical atmosphere, detailed environment, concept art, no watermark' },
  { id: 'noir',              name: '필름 누아르',         prompt: 'film noir, black and white, high contrast, shadows, dramatic mood, vintage, no watermark' },
  { id: 'pixel',             name: '픽셀 아트',           prompt: 'pixel art, retro game style, 16-bit, vibrant colors, detailed sprites, no watermark' },
  { id: 'comic',             name: '만화/코믹',           prompt: 'comic book style, bold outlines, dynamic composition, vivid colors, action panels, no watermark' },
  { id: '3d',                name: '3D 렌더링',           prompt: '3D rendered scene, ray tracing, realistic materials, cinematic lighting, Unreal Engine, no watermark' },
  { id: 'minecraft',         name: '마인크래프트',        prompt: 'Minecraft game screenshot, voxel art, blocky 3D world, cubic characters, pixel textures, in-game capture, no watermark' },
  { id: 'stickman',          name: '졸라맨 (스틱맨)',     prompt: 'simple stick figure drawing, black lines on white background, minimalist doodle, hand-drawn sketch style, funny stick characters, no watermark' },
  { id: 'ghibli',            name: '지브리 (미야자키)',   prompt: 'Studio Ghibli anime style, soft watercolor backgrounds, warm lighting, detailed nature, Hayao Miyazaki inspired, no watermark' },
  { id: 'disney',            name: '디즈니/픽사',         prompt: 'Disney 3D animation style, Pixar-like rendering, expressive characters, vibrant colors, family friendly, no watermark' },
  { id: 'chibi',             name: '치비 (귀여운)',       prompt: 'chibi anime style, cute super-deformed characters, big eyes, small body, kawaii, pastel colors, no watermark' },
  { id: 'retro',             name: '레트로 80s',          prompt: 'retro 80s synthwave, neon colors, grid landscape, sunset, VHS aesthetic, vaporwave, no watermark' },
  { id: 'sketch',            name: '연필 스케치',         prompt: 'pencil sketch drawing, graphite on paper, detailed cross-hatching, artistic hand-drawn, no watermark' },
  { id: 'pop',               name: '팝아트',              prompt: 'pop art style, Roy Lichtenstein, bold colors, halftone dots, comic book aesthetic, Andy Warhol inspired, no watermark' },
  { id: 'monochrome',        name: '모노크롬',            prompt: 'monochrome digital painting, smooth grayscale shading, black and white, strong contrast, dramatic cinematic lighting, realistic idealized llustration, detailed rendering, 4K, no watermark' },
